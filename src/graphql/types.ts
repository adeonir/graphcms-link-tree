...
export type ScheduledOperationAffectedDocument = Asset | Creator | Link | Page | Video;
...
export type PageBySlugQuery = { __typename?: 'Query', page?: { __typename?: 'Page', creator?: { __typename?: 'Creator', name: string, bio: string, avatar?: { __typename?: 'Asset', url: string } | null } | null, blocks: Array<{ __typename: 'Link', text: string, url: string } | { __typename: 'Video', url: string }> } | null };
